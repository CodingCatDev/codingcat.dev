  ...
  content?: Array<
    | {
        ...
        markDefs?: Array<
          ...
          | {
              reference?: PostReference | PodcastReference | PageReference;
              _type: "internalLink";
              _key: string;
            }
        >;
...
export type Short = {
  ...
  parentEpisode?: PodcastReference;
  publishedAt?: string;
  duration?: number;
  categories?: Array<
    {
...
export type VideoAnalytics = {
  ...
  _updatedAt: string;
  _rev: string;
  contentRef?: PostReference | PodcastReference | AutomatedVideoReference;
...
export type AutomatedVideo = {
  ...
  researchData?: string;
  infographicArtifactIds?: Array<string>;
  trendScore?: number;
  trendSources?: string;
...
export type PodcastSeriesReference = {
  _ref: string;
  _type: "reference";
  _weak?: boolean;
  [internalGroqTypeReferenceTo]?: "podcastSeries";
};

export type ShortReference = {
  _ref: string;
  _type: "reference";
  _weak?: boolean;
  [internalGroqTypeReferenceTo]?: "short";
};
...
export type Podcast = {
  ...
  transcript?: string;
  contentType?: "interview" | "solo" | "tutorial" | "news" | "review";
  relatedShorts?: Array<
    {
      _key: string;
    } & ShortReference
  >;
  relatedBlogPost?: PostReference;
};
...
export type EngineConfig = {
  ...
  trendSources?: Array<string>;
  topicFocus?: Array<string>;
  rssFeeds?: Array<{
    name?: string;
    url?: string;
    _key: string;
  ...
  infographicInstructions?: Array<string>;
  ...
  youtubeUploadVisibility?: "private" | "unlisted" | "public";
  youtubeChannelId?: string;
  youtubeDescriptionTemplate?: string;
  youtubeDefaultTags?: Array<string>;
...
export type PageQueryResult = {
  ...
  content: Array<
    | {
        ...
        markDefs: Array<
          | {
              reference?: PageReference | PodcastReference | PostReference;
              _type: "internalLink";
              _key: string;
              href: string | null;
            }
...
// Source: sanity/lib/queries.ts
// Variable: rssQuery
// Query: *[_type == $type && _id != $skip && defined(slug.current)] | order(date desc) [$offset...$limit] {    _id,  _type,  _updatedAt,  "status": select(_originalId in path("drafts.**") => "draft", "published"),  "title": coalesce(title, "Untitled"),  "slug": slug.current,  excerpt,  coverImage,  "date": coalesce(date, _createdAt),    content[]{    ...,    markDefs[]{      ...,      _type == "internalLink" => {        @.reference->_type == "page" => {          "href": "/" + @.reference->slug.current        },        @.reference->_type != "page" => {          "href": "/" + @.reference->_type + "/" + @.reference->slug.current        }      },    }  },  author[]->{    "title": coalesce(title, "Anonymous"),    "slug": slug.current,  },}
...
// Query: *[_type == "podcast" && _id != $skip && defined(slug.current)] | order(date desc) [$offset...$limit] {    _id,  _type,  _updatedAt,  "status": select(_originalId in path("drafts.**") => "draft", "published"),  "title": coalesce(title, "Untitled"),  "slug": slug.current,  excerpt,  coverImage,  "date": coalesce(date, _createdAt),    content[]{    ...,    markDefs[]{      ...,      _type == "internalLink" => {        @.reference->_type == "page" => {          "href": "/" + @.reference->slug.current        },        @.reference->_type != "page" => {          "href": "/" + @.reference->_type + "/" + @.reference->slug.current        }      },    }  },  author[]->{    "title": coalesce(title, "Anonymous"),    "slug": slug.current,  },  season,  episode,  spotify,}
