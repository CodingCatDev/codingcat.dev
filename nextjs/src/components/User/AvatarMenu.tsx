  ...
  return (
    <>
      <div className="relative ml-3">
        <div>
          {user ? (
            ...
            <Link href="/user/profile">
              <a className="flex items-center justify-center p-2 text-ccd-basics-050 rounded bg-ccd-purples-900 hover:bg-ccd-purples-700 hover:text-ccd-basics-050 focus:ring-2 focus:ring-ccd-basics-050">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 24 24"
                ...
                <span className="ml-2 hover:text-ccd-basics-050">Sign In</span>
              </a>
            </Link>
          )}
        </div>
        ...
        >
          <div
            className="absolute right-0 z-40 w-48 p-2 py-1 mt-2 origin-top-right bg-ccd-basics-050 rounded-md shadow-lg ring-1 ring-black ring-opacity-5"
            role="menu"
          ...
          >
            ...
            >
              <a
                className="p-2 flex items-center text-sm text-ccd-basics-900 hover:bg-ccd-purples-050"
                role="menuitem"
              >
