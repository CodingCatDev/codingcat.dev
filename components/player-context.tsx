...
export const PlayerContext = createContext<{
    ...
    isMinimized: boolean, setIsMinimized: Dispatch<SetStateAction<boolean>>,
    audio: {
        id: number,
        src: string,
        title: string,
        ...
        duration: number,
        playbackRate: number,
    }, setAudio: Dispatch<SetStateAction<{
        id: number;
        src: string;
        title: string;
        artist: string;
    ...
    volume: number, setVolume: Dispatch<SetStateAction<number>>
}
>({
