                      ...
                      <ul>
                        <li className="flex items-center">
                          ...
                          <div className="flex flex-col flex-wrap">
                            ...
                            <span className="max-w-sm ml-3 text-primary-900 text-md">
                              Enjoy CodingCat.dev Tutorial website 100% without
                              ads.
                            </span>
                            <span className="max-w-sm ml-3 text-primary-900 text-md">
                        ...
                        <li className="flex items-center mt-3">
                          ...
                          <div className="flex flex-col flex-wrap">
                            ...
                            <span className="max-w-sm ml-3 text-primary-900 text-md">
                              ...
                              enjoy new premium tutorial series every single
                              month.
                            </span>
                          </div>
                        </li>
                        ...
                        <li className="flex items-center mt-3">
                          ...
                          <div className="flex flex-col flex-wrap">
                            ...
                            <span className="max-w-sm ml-3 text-primary-900 text-md">
                              Some of the courses are very detailed, tracking
                              allows you to remember where you left off.
                            </span>
                          </div>
                        </li>
                      </ul>
                      ...
                      >
                        ...
                        {user && user.memberships && (
                          <p className="p-8 text-xl text-primary-800">
                            ...
                            ! You can see all of your information in the
                            selections below, just click the button and a
                            detailed table data will appear.
                          </p>
                        )}
                      </div>
                    </div>
