            ...
            >
              <div
                className={`${
                  user.memberships
                    ? 'rounded'
                    : 'p-4 flex flex-wrap items-center gap-4 justify-center'
                } flex flex-wrap max-w-lg mx-auto`}
              >
                {user.photoURL && (
                  <img
                    src={user.photoURL}
            ...
            <section>
              <div className="grid gap-3 m-2 justify-items-center place-items-center">
                <div className="text-2xl">
                  You are already a member. Would you like to see your
                  membership? Or just start with courses?
                </div>
              ...
              <section className="grid grid-cols-1 gap-10 px-4 py-10 text-center">
                <div className="max-w-xl mx-auto">
                  ...
                  <h2 className="mt-4 font-sans text-lg lg:text-lg text-basics-600">
                    Get access to all of the exclusive content and up your
                    coding skills.
                  </h2>
                </div>
