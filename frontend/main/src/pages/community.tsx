    ...
    <Layout site={site}>
      ...
      <section className="grid grid-cols-1 gap-10 p-4 sm:p-10 place-items-center">
        ...
        <a href="https://discord.gg/kGYAaAKZQf">
          <button className="flex px-4 py-2 space-x-2 transform rounded-md shadow-lg bg-basics-600 dark:bg-basics-600 hover:text-basics-50 dark:hover:text-basics-50 text-basics-50 dark:text-basics-50 hover:shadow-md hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-secondary-600">
            <svg
              width="23"
              height="23"
              viewBox="0 0 23 23"
