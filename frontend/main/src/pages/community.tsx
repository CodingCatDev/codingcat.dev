...
import { getSite, getAuthors } from '@/services/notion.server';
...
const Community = ({
  ...
  return (
    <>
      ...
      ></NextSeo>
      <Layout site={site}>
        <section className="grid grid-cols-1 gap-2 p-4 sm:p-10 place-items-center">
          <section className="text-center">
            <h2 className="mb-2 text-4xl lg:text-5xl">CodingCat.Dev Discord</h2>
            <h3 className="mb-4 font-sans text-2xl">
              Now part of the Learn Build Teach Community
            </h3>
          </section>
          <div>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center justify-center px-8 py-4 mx-auto space-x-2 rounded-md shadow-lg w-min bg-basics-600 dark:bg-basics-600 hover:text-basics-50 dark:hover:text-basics-50 text-basics-50 hover:shadow-md hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-secondary-600"
            >
              <svg
                className="w-8"
                viewBox="0 0 23 23"
          ...
          <div>
            <Image
              src="/main-codingcatdev-photo/Screen_Shot_2022-04-06_at_6.10.35_PM.png"
              alt=""
              layout="fixed"
              height="800px"
              width="1200px"
