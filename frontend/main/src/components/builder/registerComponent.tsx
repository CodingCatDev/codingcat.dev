...
export default function registerComponent() {
  const res = dynamic(
    () =>
      import('@builder.io/react').then((res) => {
        const withChildren = res.withChildren;
        ...
        Builder.registerComponent(
          dynamic(
            () =>
              import('@/components/global/icons/AJPrimary').then(
                (res) => res as any
              ),
            { ssr: false }
          ),
        ...
        Builder.registerComponent(
          dynamic(
            () =>
              import('@/components/global/icons/AJAlt').then(
                (res) => res as any
              ),
            { ssr: false }
          ),
        ...
        Builder.registerComponent(
          dynamic(
            () =>
              import('@/components/global/icons/AJHeartAlt').then(
                (res) => res as any
              ),
            { ssr: false }
          ),
        ...
        Builder.registerComponent(
          dynamic(
            () =>
              import('@/components/global/icons/KCAlt').then(
                (res) => res as any
              ),
            { ssr: false }
          ),
        ...
        Builder.registerComponent(
          withChildren(
            dynamic(
              () =>
                import('@/components/home/BreakBarLeft').then(
                  (res) => res as any
                ),
              { ssr: false }
            )
        ...
        Builder.registerComponent(
          dynamic(
            () =>
              import('@/components/global/icons/nav/Courses').then(
                (res) => res as any
              ),
            { ssr: false }
          ),
        ...
        Builder.registerComponent(
          dynamic(
            () =>
              import('@/components/global/icons/nav/Blog').then(
                (res) => res as any
              ),
            { ssr: false }
          ),
        ...
        Builder.registerComponent(
          dynamic(
            () =>
              import('@/components/global/icons/Toggle').then(
                (res) => res as any
              ),
            { ssr: false }
          ),
        ...
        Builder.registerComponent(
          dynamic(
            () =>
              import('@/components/algolia/SearchModal').then(
                (res) => res as any
              ),
            { ssr: false }
          ),
        ...
        Builder.registerComponent(
          dynamic(
            () =>
              import('@/layout/AppTopbar').then(
                (res) => res.AvatarMenuWrapper as any
              ),
            { ssr: false }
          ),
          {
        ...
        Builder.registerComponent(
          dynamic(
            () => import('@/components/PostsCards').then((res) => res as any),
            {
              ssr: false,
            }
          ),
        ...
        Builder.registerComponent(
          dynamic(
            () =>
              import('@/components/common/SocialShare').then(
                (res) => res as any
              ),
            { ssr: false }
          ),
        ...
        Builder.registerComponent(
          dynamic(
            () => import('@/components/SponsorCards').then((res) => res as any),
            {
              ssr: false,
            }
          ),
