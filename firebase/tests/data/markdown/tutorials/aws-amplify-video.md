...
![](https://res.cloudinary.com/ajonp/image/upload/v1600716754/codingcat.dev/image_86625a74.png)

![TODO_UPLOAD](https://res.cloudinary.com/ajonp/image/upload/f_auto,q_auto/ajonp-ajonp-com/uploads/eqryxullhupbx6fqtl1m.png)

## React setup

I would recommend this guide for fully setting up a React project.[https://docs.amplify.aws/start/getting-started/setup/q/integration/react#initialize-a-new-backend](https://docs.amplify.aws/start/getting-started/setup/q/integration/react#initialize-a-new-backend)npx is an npm command that will fetch the necessary dependencies and create a React Application.
...
![TODO_UPLOAD](https://res.cloudinary.com/ajonp/image/upload/f_auto,q_auto/ajonp-ajonp-com/uploads/xjbuxdj1l7ozpdw8zebr.png)
...
![TODO_UPLOAD](https://res.cloudinary.com/ajonp/image/upload/f_auto,q_auto/ajonp-ajonp-com/uploads/stboiq6bb77qlycakn5g.png)
...
![TODO_UPLOAD](https://res.cloudinary.com/ajonp/image/upload/f_auto,q_auto/ajonp-ajonp-com/uploads/l3qxsmypayxy0yiegfzg.png)
...
![TODO_UPLOAD](https://res.cloudinary.com/ajonp/image/upload/f_auto,q_auto/ajonp-ajonp-com/uploads/lf33ggz1fsrcfwlypjs1.png)

This is very similar to the larger image diagram that AWS has listed, however it is much simpler to follow.[https://aws.amazon.com/solutions/implementations/video-on-demand-on-aws/](https://aws.amazon.com/solutions/implementations/video-on-demand-on-aws/)

![TODO_UPLOAD](https://res.cloudinary.com/ajonp/image/upload/f_auto,q_auto/ajonp-ajonp-com/uploads/kse1yejh02xcqktxmngr.png)
...
![TODO_UPLOAD](https://res.cloudinary.com/ajonp/image/upload/f_auto,q_auto/ajonp-ajonp-com/uploads/brxjazwgwgk9u81t1lhj.png)
...
![TODO_UPLOAD](https://res.cloudinary.com/ajonp/image/upload/f_auto,q_auto/ajonp-ajonp-com/uploads/d65ozuyqrmuhasuliqmr.png)
...
![TODO_UPLOAD](https://res.cloudinary.com/ajonp/image/upload/f_auto,q_auto/ajonp-ajonp-com/uploads/t7wkoptwyrawuz3qlve3.png)
...
![TODO_UPLOAD](https://res.cloudinary.com/ajonp/image/upload/f_auto,q_auto/ajonp-ajonp-com/uploads/lerlbapelbtxuqj6jlol.png)

It will then trigger a Lambda to start Media Convert, you can see what events are subscribed on the properties tab in S3.

![TODO_UPLOAD](https://res.cloudinary.com/ajonp/image/upload/f_auto,q_auto/ajonp-ajonp-com/uploads/wrp9irrhhgrzylpqgx3d.png)

This Lambda should have the <yourprojectname>-dev-inputWatcher

![TODO_UPLOAD](https://res.cloudinary.com/ajonp/image/upload/f_auto,q_auto/ajonp-ajonp-com/uploads/l3nzmpxbqbtbbozlhn16.png)
...
![TODO_UPLOAD](https://res.cloudinary.com/ajonp/image/upload/f_auto,q_auto/ajonp-ajonp-com/uploads/qaavyhrbcctxasrylmpx.png)

If you select one of those jobs you will find the input and outputs in the summary.

![TODO_UPLOAD](https://res.cloudinary.com/ajonp/image/upload/f_auto,q_auto/ajonp-ajonp-com/uploads/ucmibhr7mwqlvrwlwuue.png)

Now you will find that exact structure in your output S3 bucket.

![TODO_UPLOAD](https://res.cloudinary.com/ajonp/image/upload/f_auto,q_auto/ajonp-ajonp-com/uploads/hwxd5brgmyyafcqozrsg.png)

If you open that "folder" you can see that there are several files listed that the conversion created.

![TODO_UPLOAD](https://res.cloudinary.com/ajonp/image/upload/f_auto,q_auto/ajonp-ajonp-com/uploads/blla8h1gmeuncxkwwj58.png)
