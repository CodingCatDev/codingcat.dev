    ...
    "scenes": [
      {
        ...
        "imagePrompts": ["Infographic 2D architecture style. STRICTLY black (#000000) background only \u2014 no gradients, no blue. [specific visual for this scene]. Highlighted elements filled with vivid purple (#6D28D9) only. White lines connecting components and white text annotations. Large, readable labels."]
      }
    ],
...
- Each scene MUST include 2-5 imagePrompts following this exact template: "Infographic 2D architecture style. STRICTLY black (#000000) background only \u2014 no gradients, no blue. [specific visual]. Highlighted elements filled with vivid purple (#6D28D9) only. White lines connecting components and white text annotations. Large, readable labels."
